...
public class pressSmile : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        if (!disabledButton)
        {
            ...
            handler.currentEvent.pressBlue();

            // disable other buttons
            SpriteRenderer srRed = redButton.GetComponent<SpriteRenderer>();
            srRed.sprite = redButton.GetComponent<pressNo>().buttonDisabled;
            redButton.GetComponent<pressNo>().disabledButton = true;
            ...
            tg.text = handler.GetComponent<eventHandler>().currentEvent.blueChoice.result_text;
